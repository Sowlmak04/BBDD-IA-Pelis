// ---------- Rating widget (10 estrellas, medias con click) ----------
    ...
    wireEditBackButton(document.querySelector('.screen[data-screen="anadir-series-pendientes"] #form-series-pendientes .backBtn'));
    wireEditBackButton(document.querySelector('.screen[data-screen="anadir-peliculas-pendientes"] #form-peliculas-pendientes .backBtn'));
    wireEditBackButton(document.querySelector('.screen[data-screen="anadir-series-vistas"] #form-series-vistas .backBtn'));
    wireEditBackButton(document.querySelector('.screen[data-screen="anadir-peliculas-vistas"] #form-peliculas-vistas .backBtn'));
