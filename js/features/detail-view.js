...
const DetailView = (() => {
  ...
  function dubbingMarkup(item) {
    ...
    return `<div class="detailDubbing">
      <div class="detailDubbingStatus detailDubbingStatusLinked">
        <span class="detailDubbingIcon" aria-hidden="true">🔗</span>
        <div><strong>Ficha de doblaje vinculada</strong><p>Fuente: eldoblaje.com</p></div>
      </div>
      <div class="detailDubbingActions">
