...
function initTMDbSearchBlock(block) {
  ...
  results.addEventListener("click", async event => {
    ...
    setMessage("Cargando ficha completa y disponibilidad…");
    ...
    try {
      ...
      setMessage(
        availabilityError
          ...
          : "Ficha completa y disponibilidad cargadas. Puedes revisarlas antes de guardar.",
...
function resetTMDbFormState(form) {
  ...
  const metadataNames = [
    ...
    "creators", "watchRegion", "watchProviders", "watchProvidersLink",
    "watchProvidersUpdatedAt"
  ];
